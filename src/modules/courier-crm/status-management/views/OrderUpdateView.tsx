...
const statusColorMap: Record<string, string> = {
  ...
  delivery_assigned: "bg-orange-50 text-orange-700 border-orange-200",
        ...
        <div className="space-y-5 animate-in fade-in-0 slide-in-from-top-2 duration-300">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
            ...
            <div className="xl:col-span-2 space-y-5">
              <OrderStatusUpdateForm order={order} onUpdated={setOrder} />
              <ParcelDetailsUpdateForm order={order} onUpdated={setOrder} />
            </div>
      ...
      {!order && !searchError && !isSearching && (
        <div className="text-center py-20">
          ...
          <p className="text-gray-500 text-sm max-w-sm mx-auto">
            Enter an order number above to load order details and make manual
            updates for walk-in or exception cases.
          </p>
        </div>
      )}
    </div>
